...
namespace AtlasNOC.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260915230648_AttachSupportTicketsToServices")]
    partial class AttachSupportTicketsToServices
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AtlasNOC.Domain.Entities.BillingAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("AtlasNOC.Domain.Entities.BillingEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("AccountId", "Type", "IdempotencyKey")
                        .IsUnique();

                    b.ToTable("BillingEntries", (string)null);
                });

            modelBuilder.Entity("AtlasNOC.Domain.Entities.ConfigurationRevision", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("DeviceId", "Revision")
                        .IsUnique();

                    b.ToTable("ConfigurationRevisions", (string)null);
                });

            modelBuilder.Entity("AtlasNOC.Domain.Entities.CoverageCheck", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("CoverageChecks", (string)null);
                });

            modelBuilder.Entity("AtlasNOC.Domain.Entities.CpeAuthorizationCase", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<string>("EnforcementEvidence")
                        .HasColumnType("longtext");
                    ...
                    b.ToTable("CpeAuthorizationCases", (string)null);
                });

            modelBuilder.Entity("AtlasNOC.Domain.Entities.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("AtlasNOC.Domain.Entities.CustomerService", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<string>("ProvisioningEvidence")
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("AtlasNOC.Domain.Entities.DeviceCredential", b =>
                {
                    ...
                    b.HasIndex("DeviceId", "DriverKey", "IsPreferred");
            ...
            modelBuilder.Entity("AtlasNOC.Domain.Entities.InstallationOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("CustomerServiceId", "Status");

                    b.ToTable("InstallationOrders", (string)null);
                });

            modelBuilder.Entity("AtlasNOC.Domain.Entities.InventoryAsset", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("InventoryAssets", (string)null);
                });
            ...
            modelBuilder.Entity("AtlasNOC.Domain.Entities.PaymentPromise", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("PaymentPromises", (string)null);
                });

            modelBuilder.Entity("AtlasNOC.Domain.Entities.PaymentReceipt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("AtlasNOC.Domain.Entities.Prospect", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("AtlasNOC.Domain.Entities.ServiceContract", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("AtlasNOC.Domain.Entities.ServiceCredit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("ServiceCredits", (string)null);
                });
            ...
            modelBuilder.Entity("AtlasNOC.Domain.Entities.ServicePlan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("AtlasNOC.Domain.Entities.SupportInteraction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<Guid?>("RootIncidentId")
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("SupportInteractions", (string)null);
                });

            modelBuilder.Entity("AtlasNOC.Domain.Entities.SupportTicket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("AtlasNOC.Domain.Entities.TechnicianVisit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("TechnicianVisits", (string)null);
                });
            ...
            modelBuilder.Entity("AtlasNOC.Domain.Entities.WispClientObservation", b =>
                {
                    ...
                    b.HasIndex("ExternalId", "Source", "ObservedAtUtc")
                        .IsUnique();
            ...
            modelBuilder.Entity("AtlasNOC.Domain.Entities.CustomerService", b =>
                {
                    b.HasOne("AtlasNOC.Domain.Entities.NetworkZone", null)
                        .WithMany()
            ...
            modelBuilder.Entity("AtlasNOC.Domain.Entities.SupportTicket", b =>
                {
                    b.HasOne("AtlasNOC.Domain.Entities.CustomerService", null)
                        .WithMany()
