...
| Reliability | PROVEN IN LAB | Unit 178/178, Integration 10/10, Runtime 9/9, E2E 19/19 | Carga de producción no medida | Ejecutar prueba de carga objetivo |
...
| Supportability | PROVEN IN LAB | Runbook, error correlation, tickets ligados a `CustomerService`, incidents/visits; smoke valida el vínculo | Guardias reales no definidas | Crear proceso de soporte |
